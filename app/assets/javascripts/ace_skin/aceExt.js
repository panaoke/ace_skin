        ...
        $(container).find('[data-toggle="rich_text"]').each(function () {
            $(this).ace_wysiwyg({
                toolbar: [
                    ...
                    {name: 'backColor',title: i18n.view('rich_text', 'backColor') },
                    null,
                    {name: 'createLink',
                        title: i18n.view('rich_text', 'createLink'),
                        placeholder: i18n.view('rich_text', 'createLinkPlaceholder'),
                        button_text: i18n.view('rich_text', 'insertLink')
                    },
                    {name: 'unlink',title: i18n.view('rich_text', 'unlink') },
                    {name: 'class',
                        title: i18n.view('rich_text', 'class'),
                        placeholder: i18n.view('rich_text', 'createClassPlaceholder'),
                        button_text: i18n.view('rich_text', 'insertClass')
                    },
                    null,
                    {name: 'insertImage',
